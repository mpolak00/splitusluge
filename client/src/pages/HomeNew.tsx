    ...
    return buildSeoPayload({
      ...
      structuredData: [
        ...buildBaseStructuredData(siteUrl || "https://majstorisplit.com"),
        {
          ...
          name: title,
          description,
          url: siteUrl || "https://majstorisplit.com",
          inLanguage: "hr-HR",
        ...
        },
        {
          ...
          itemListElement: categorySummaries.slice(0, 8).map((category, index) => ({
            ...
            position: index + 1,
            name: category.name,
            url: `${siteUrl || "https://majstorisplit.com"}/usluga/${category.slug}`,
          })),
        },
      ],
    });
            ...
            <div className="flex flex-col gap-2 md:flex-row md:items-end md:justify-between">
              <div>
                ...
                <p className="mt-2 text-muted-foreground">
                  Pronađeno {filteredBusinesses.length} rezultata za upit &ldquo;{searchTerm}&rdquo;.
                </p>
              </div>
              ...
              <Card className="border-border/70">
                <CardContent className="space-y-3 p-6">
                  ...
                  <p className="text-sm leading-7 text-muted-foreground">
                    ...
                    poput &ldquo;vodoinstalater Split&rdquo;, &ldquo;frizer Split&rdquo; ili &ldquo;selidbe Split&rdquo;.
                  </p>
                </CardContent>
              </Card>
              <Card className="border-border/70">
                ...
                <CardContent className="space-y-5 p-6 md:p-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="rounded-2xl border border-border/70 bg-muted/30 p-4">
                      ...
                      <p className="mt-2 text-sm leading-7 text-muted-foreground">
                        Zato što svako poslovanje dobiva svoju indeksabilnu stranicu s kontaktima, lokacijom,
